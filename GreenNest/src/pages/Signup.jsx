...
const Signup = () => {
  ...
  return (
    <div className="min-h-[96vh] flex items-center justify-center bg-gradient-to-br from-orange-500 via-purple-600 to-pink-500 relative overflow-hidden">
   
      <div className="absolute inset-0">
        <div className="absolute w-72 h-72 bg-pink-400/30 rounded-full blur-2xl top-10 left-10 animate-pulse"></div>
        <div className="absolute w-72 h-72 bg-orange-400/30 rounded-full blur-2xl bottom-10 right-10 animate-pulse"></div>
      </div>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 p-6 lg:p-10 text-white">
          <div className="max-w-lg text-center lg:text-left">
            ...
            <p className="mt-4 text-lg text-white/80 leading-relaxed">
              ...
              begins here!
              🌳 “Every tree you plant is a breath of life for the future.”
            </p>
          </div>
